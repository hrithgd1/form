A simple project that registers a user, and login using the credentials entered during registration. Then a home page that greets the specific user who logged in and displays. the details of the user.
